...
public enum PermissionLevel {
    ...
    ADMIN(3, "Usuário adminstrador. Possui privilégios de visualização de documentos vinculados a outros users."),
    SUPER_ADMIN(4, "Usuário com privilégio de deleção, super adminstrador do sistema.");
